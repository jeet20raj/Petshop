(function() {
	...
	function ProductService($http, $log, $rootScope) {
		...
		function getAllProducts() {
			return $http.get($rootScope.contextPath + 'rest/products').then(
					handleSuccess,
		...
		function createProduct(product) {
			...
			return $http
					.post($rootScope.contextPath + 'rest/products', product)
					.then(handleSuccess,
							handleError('Error getting user by username'));
		}
		...
		function editProduct(product) {
			$log.debug(JSON.stringify(product));
			return $http
					.put($rootScope.contextPath + 'rest/products', product)
					.then(handleSuccess,
							handleError('Error getting user by username'));
		}

		function getAllCategories() {
			return $http.get($rootScope.contextPath + 'rest/categories').then(
					handleSuccess,
					handleError('Error getting user by username'));
		}
		...
		function createCategory(category) {
			...
			return $http.post($rootScope.contextPath + 'rest/categories',
